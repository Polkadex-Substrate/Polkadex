...
impl<T: frame_system::Config> crate::TheaWeightInfo for WeightInfo<T> {
	...
	fn incoming_message(_b: u32, ) -> Weight {
		...
		Weight::from_parts(22_066_762, 0)
	...
	fn send_thea_message(b: u32, ) -> Weight {
		...
		//  Measured:  `315`
		//  Estimated: `3780`
		// Minimum execution time: 338_680_000 picoseconds.
		Weight::from_parts(354_563_698, 0)
			.saturating_add(Weight::from_parts(0, 3780))
			// Standard Error: 307
			.saturating_add(Weight::from_parts(8_025, 0).saturating_mul(b.into()))
