...
impl pallet_staking::Config for Runtime {
	...
	type Event = Event;
	type Slash = (); // Tresury // send the slashed funds to the treasury.
		...
		Call: From<LocalCall>,
{
	fn create_transaction<C: frame_system::offchain::AppCrypto<Self::Public, Self::Signature>>(
		...
		let extra = (
			...
			polkadex::PolkadexData::<Runtime>::new()
		);
...
parameter_types! {
    pub const MaxSubAccountsPolkadex: u32 = 10;
    pub const MaxRegistrarsPolkadex: u32 = 10;
}
...
parameter_types! {
	...
	pub const TradingPairReservationFeePolkadex: u128 = 1_000_000_000_000;
}
