   ...
   impl sp_api::Metadata<Block> for Runtime {
	...
	impl ocex_primitives::OcexApi<Block> for Runtime {
		...
		fn submit_approve_enclave_report(approver: ocex_primitives::AuthorityId,
			signature: ocex_primitives::AuthoritySignature, report: Vec<u8>) -> Result<(), ocex_primitives::SigningError>{
			OCEX::submit_approve_enclave_report(approver, signature, report)
		}
