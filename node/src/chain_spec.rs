...
use node_polkadex_runtime::{
	constants::currency::{PDEX, *},
	wasm_binary_unwrap, AuthorityDiscoveryConfig, BabeConfig, BalancesConfig, CouncilConfig,
	IndicesConfig, OrmlVestingConfig, PDEXMigrationConfig, PolkadexOcexConfig, SessionConfig,
...
pub fn testnet_genesis(
	...
	info!(
		"🧮  Assert Total supply is 20 million: {} == {} ",
	...
	endowed_accounts.append(&mut vec![(bob.clone(), 1000000000000000000u128)]);
	...
	GenesisConfig {
		...
		tokens: TokensConfig {
			balances: vec![
				(alice.clone(), AssetId::Asset(4294967297), 1000000000000000000u128),
				(alice.clone(), AssetId::Asset(840), 1000000000000000000u128),
				(bob.clone(), AssetId::Asset(4294967297), 1000000000000000000u128),
				(bob.clone(), AssetId::Asset(840), 1000000000000000000u128),
			],
		},
		polkadex_ocex: PolkadexOcexConfig { key: genesis.clone(), genesis_account: genesis },
	}
}
...
pub fn get_vesting_terms() -> Vec<(AccountId, u32, u32, u32, Balance)> {
	...
	// vec![ (hex!["148d5e55a937b6a6c80db86b28bc55f7336b17b13225e80468eef71d01c79341"].into(), 1,
	// 30, 1, 3655828 * PDEX)]
	vec![]
}
...
pub fn get_stakeholder_tokens() -> Vec<(AccountId, Balance)> {
	let claims = vec![
		...
		(
			hex!["148d5e55a937b6a6c80db86b28bc55f7336b17b13225e80468eef71d01c79341"].into(),
			3655828 * PDEX,
		),
	];
	claims
