...
parameter_types! {
	...
	pub KsmPerSecondPerByte: (AssetId, u128, u128) = (AssetId::try_from(xcm::opaque::v3::AssetId::Concrete(xcm::opaque::v3::Parent.into())).unwrap(), 1, 1);
...
parameter_types! {
	pub NftCollectionOne: AssetFilter
		= Wild(AllOf { fun: WildNonFungible, id: AssetId::try_from(xcm::opaque::v3::AssetId::Concrete((xcm::opaque::v3::Parent, xcm::opaque::v3::Junction::GeneralIndex(1)).into())).unwrap() });
