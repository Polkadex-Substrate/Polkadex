...
use frame_support::traits::{AsEnsureOriginWithArg, ConstBool};
...
/// Block header type as expected by this polkadex-parachain.
pub type Header = generic::Header<BlockNumber, BlakeTwo256>;

/// Block type as expected by this polkadex-parachain.
pub type Block = generic::Block<Header, UncheckedExtrinsic>;

/// A Block signed with a Justification
pub type SignedBlock = generic::SignedBlock<Block>;

/// BlockId type as expected by this polkadex-parachain.
...
/// Unchecked extrinsic type as expected by this polkadex-parachain.
...
/// the specifics of the polkadex-parachain. They can then be made to be agnostic over specific
/// formats of data like extrinsics, allowing for them to continue syncing the network through
/// upgrades to even the core data structures.
pub mod opaque {
	use super::*;
...
/// The version information used to identify this polkadex-parachain when compiled natively.
#[cfg(feature = "std")]
...
impl frame_system::Config for Runtime {
	...
	/// Converts a module to an index of this module in the polkadex-parachain.
	...
	/// The weight of database operations that the polkadex-parachain can invoke.
...
construct_runtime!(
	pub struct Runtime {
		...
		MessageQueue: pallet_message_queue = 47,
...
impl_runtime_apis! {
	...
	impl frame_try_runtime::TryRuntime<Block> for Runtime {
		...
		fn execute_block(block: Block, state_root_check: bool,signature_check: bool, select: frame_try_runtime::TryStateSelect) -> Weight {
			log::info!(
				target: "polkadex-parachain::parachain-polkadex", "try-polkadex-parachain: executing block #{} ({:?}) / root checks: {:?} / sanity-checks: {:?}",
				block.header.number,
				block.header.hash(),
				state_root_check,
				select,
