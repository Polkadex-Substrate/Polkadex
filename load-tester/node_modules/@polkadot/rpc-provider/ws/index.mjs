...
export class WsProvider {
  ...
  async connectWithRetry() {
    try {
      ...
      }, _classPrivateFieldLooseBase(this, _autoConnectMs)[_autoConnectMs] || RETRY_DELAY);
    }
  }
  /**
