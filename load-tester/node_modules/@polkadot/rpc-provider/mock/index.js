...
class MockProvider {
  ...
  init() {
    ...
    let counter = -1;
    const metadata = new _metadata.Metadata(this.registry, _static.default);
    this.registry.setMetadata(metadata);
    const query = (0, _metadata.decorateStorage)(this.registry, metadata.asLatest, metadata.version); // Do something every 1 seconds
