...
impl sc_executor::NativeExecutionDispatch for ParachainNativeExecutor {
	...
	fn native_version() -> sc_executor::NativeVersion {
		parachain_polkadex_runtime::native_version()
	}
}
...
type ParachainPartialComponents = PartialComponents<
	ParachainClient,
	ParachainBackend,
	(),
...
) -> Result<ParachainPartialComponents, sc_service::Error> {
...
/// Start a polkadex-parachain-node with the given parachain `Configuration` and relay chain
/// `Configuration`.
///
...
/// Start a parachain polkadex-parachain-node.
