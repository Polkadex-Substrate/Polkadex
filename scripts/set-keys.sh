...
curl http://localhost:9944 -H "Content-Type:application/json;charset=utf-8" -d "@../session-keys/thea1"
...
curl http://localhost:9946 -H "Content-Type:application/json;charset=utf-8" -d "@../session-keys/thea2"
...
curl http://localhost:9948 -H "Content-Type:application/json;charset=utf-8" -d "@../session-keys/thea3"
