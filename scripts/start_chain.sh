...
start_validator_1() {
  ...
  ../../target/$TARGET/polkadex-polkadex-mainnet-polkadex-parachain-node --validator --port 30334 --base-path ./validator01  --thea-dummy-mode \
    ...
    --polkadex-mainnet-polkadex-parachain-node-key=d353c4b01db05aa66ddeab9d85c2fa2252368dd4961606e5985ed1e8f40dbc50 >out_validator_1 2>&1 &
...
start_validator_2() {
  ...
  ../../target/$TARGET/polkadex-polkadex-mainnet-polkadex-parachain-node --validator --port 30335 --base-path ./validator02 -lthea=trace --thea-dummy-mode \
    ...
    --polkadex-mainnet-polkadex-parachain-node-key=24f121a84149f784f9fe3f1e2fb04e8873191a510bc4b073a3a815d78a29cf2d >out_validator_2 2>&1 &
...
start_full_node() {
  ...
  ../../target/$TARGET/polkadex-polkadex-mainnet-polkadex-parachain-node  --chain=../../scripts/customSpecRaw.json --pruning=archive \
  --bootnodes /ip4/127.0.0.1/tcp/30333/p2p/12D3KooWRozCnsH7zCYiNVpCRqgaoxukPdYxqaPQNs9rdDMDeN4t \
...
kill_nodes() {
  echo "Killing nodes..."
  killall -2 polkadex-polkadex-mainnet-polkadex-parachain-node
}
