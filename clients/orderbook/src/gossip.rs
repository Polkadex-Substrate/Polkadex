        ...
        B: Block,
{
    ...
    /// helper function to validate the incoming message
    ...
    /// helper function to check if the message should be rebroadcasted to the network
        ...
        B: Block,
{
    ...
    /// validate a incoming message
    /// return the validation result
    ///  * `Discard` - discard the message
    /// * `ProcessAndKeep` - process the message and propagate
    /// * `ProcessAndSkip` - process the message and do not propagate
    fn validate(
        &self,
    ...
    /// validate messages on a given topic.
    ...
    /// validate an outgoing messsage.
    /// return true if the message is allowed to be sent
