...
- **Storage** - A NVMe solid state drive. Should be reasonably sized to deal with blockchain growth. Starting around 800GB - 1600GB will be okay for the first six months of Polkadex, but will need to be re-evaluated every six months.
- **Memory** - 64GB
...
User=ubuntu
Group=ubuntu
ExecStart=$HOME/parachain-polkadex-node --chain=$HOME/polkadot-parachain-raw.json --port 40333 --ws-port 9902 --rpc-port 8844 --bootnodes /ip4/3.108.191.170/tcp/40333/p2p/12D3KooWKi39o5WvzPTFz8W2KMqjP5c9HWoY2naYGPVF1YANCFnC -- --execution wasm --chain $HOME/polkadot.json --port 30343 --ws-port 9977 --pruning=archive
Restart=on-failure
